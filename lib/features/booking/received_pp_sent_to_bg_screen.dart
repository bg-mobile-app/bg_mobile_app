...
class ReceivedPpSentToBgScreen extends StatefulWidget {
  const ReceivedPpSentToBgScreen({super.key});

  @override
  State<ReceivedPpSentToBgScreen> createState() =>
      _ReceivedPpSentToBgScreenState();
}
...
class _ReceivedPpSentToBgScreenState extends State<ReceivedPpSentToBgScreen> {
  ...
  List<BookingItem> get _filteredBookings {
    ...
    final seeded = ppSentToBgOnly.isEmpty
        ? const [
            BookingItem(
              workPermitId: 'WP-PPS-1001',
              id: 7905,
              serviceType: 'Work Permit',
              createdAt: '2026-05-01',
              name: 'Demo Applicant',
              passportNo: 'D00000005',
              fromCountry: 'Bangladesh',
              toCountry: 'Kuwait',
              agencyTotalCost: 95000,
              paidAmount: 50000,
              status: 'PP_SENT_TO_BG',
              statusLabel: 'PP Sent to BG',
            ),
          ]
        : ppSentToBgOnly;
