                  ...
                  OutlinedButton(
                    onPressed: () {
                      ...
                      showDialog(
                        context: context,
                        builder: (ctx) => AlertDialog(
                          title: const Text('Handover Passport'),
                          content: const Text('Are you sure you want to handover this passport to the customer?'),
                          actions: [
                            TextButton(
                              onPressed: () => Navigator.pop(ctx),
                              ...
                              onPressed: () async {
                                ...
                                try {
                                  await _bookingService.updateBookingStatus(
                                    bookingId: item.id,
                                    status: 'HANDOVERED_TO_CUSTOMER',
                                  );
                                  if (mounted) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      const SnackBar(content: Text('Passport handed over successfully.')),
                                    );
                                  }
                                  _fetchData();
                                } catch (e) {
