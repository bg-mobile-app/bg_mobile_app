...
class ReceivedRejectFlightScreen extends StatefulWidget {
  const ReceivedRejectFlightScreen({super.key});

  @override
  State<ReceivedRejectFlightScreen> createState() =>
...
class _ReceivedRejectFlightScreenState
  ...
  final List<BookingItem> _bookings = const [
    // Empty initial list to demonstrate fallback dummy data if needed
  ];
  ...
  List<BookingItem> get _filteredBookings {
    ...
    final seeded = rejectFlightOnly.isEmpty
        ? const [
            BookingItem(
              workPermitId: 'WP-REJ-1001',
              id: 7908,
              serviceType: 'Work Permit',
              createdAt: '2026-05-01',
              name: 'Demo Applicant',
              passportNo: 'D00000008',
              fromCountry: 'Bangladesh',
              toCountry: 'Singapore',
              agencyTotalCost: 95000,
              paidAmount: 20000,
              status: 'REJECT_FLIGHT',
              statusLabel: 'Reject Flight',
            ),
          ]
        : rejectFlightOnly;
