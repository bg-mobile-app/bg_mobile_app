...
class ReceivedTicketDoneScreen extends StatefulWidget {
  const ReceivedTicketDoneScreen({super.key});

  @override
  State<ReceivedTicketDoneScreen> createState() =>
      _ReceivedTicketDoneScreenState();
}

class _ReceivedTicketDoneScreenState extends State<ReceivedTicketDoneScreen> {
  ...
  List<BookingItem> get _filteredBookings {
    ...
    final seeded = ticketDoneOnly.isEmpty
        ? const [
            BookingItem(
              workPermitId: 'WP-TKT-1001',
              id: 7904,
              serviceType: 'Work Permit',
              createdAt: '2026-05-01',
              name: 'Demo Applicant',
              passportNo: 'D00000004',
              fromCountry: 'Bangladesh',
              toCountry: 'UAE',
