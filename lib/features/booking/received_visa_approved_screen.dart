...
class ReceivedVisaApprovedScreen extends StatefulWidget {
  const ReceivedVisaApprovedScreen({super.key});

  @override
  State<ReceivedVisaApprovedScreen> createState() =>
...
class _ReceivedVisaApprovedScreenState
  ...
  Widget _buildCardList() => Column(
    ...
    children: [
      Text(
        'Visa Approved • ${_filteredBookings.length} total entries',
