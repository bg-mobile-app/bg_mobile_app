...
class _PassportReturnAcceptScreenState
  ...
  final List<ReturnAcceptItem> _items = const [
    ReturnAcceptItem(
      workPermitId: 'WP-RET-2001',
      id: 8811,
      ...
      agencyTotalCost: 70000,
      paidAmount: 35000,
      isMyReturn: false,
    ),
    ReturnAcceptItem(
      workPermitId: 'WP-RET-2002',
      id: 8812,
  ...
  List<ReturnAcceptItem> get _filteredItems {
  ...
  void _openActionsSheet(BuildContext context, ReturnAcceptItem item) {
...
class ReturnAcceptItem {
  const ReturnAcceptItem({
